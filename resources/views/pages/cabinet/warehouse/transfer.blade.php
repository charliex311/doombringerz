...
@section('title', __('Отправить') . " " . $warehouse->name . __('в игру'))
                ...
                <div class="card card-bordered">
                    <div class="card-inner">
                        <div class="card-title-group">
                            <h5 class="card-title">
                                <span class="mr-2">{{ __('Отправить в игру') }}: <span class="text-primary">{{ $warehouse->name }} {{ $warehouse->enchant > 0 ? "+{$warehouse->enchant}" : '' }}</span></span>
                            </h5>
                        </div>
                    </div>
                    <div class="card-inner border-top">
                        <form action="{{ route('warehouse.transfer', $warehouse) }}" method="POST">
                            @csrf
