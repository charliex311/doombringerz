...
@section('title', "Инвентарь: {$character->char_name}")
                ...
                <div class="card card-bordered">
                    <div class="card-inner">
                        <div class="card-title-group">
                            <h5 class="card-title">
                                <span class="mr-2">Инвентарь персонажа <span class="text-primary">{{ $character->char_name }}</span></span>
                            </h5>
                        </div>
                    </div>
                            ...
                            @forelse($items as $item)
                                @if ($item->icon && $item->name)
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col"> <span>{{ $item->amount }} шт.</span> </div>
