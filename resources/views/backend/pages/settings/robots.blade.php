...
@section('headerDesc', __('Настройки') . " Robots.txt.")
                                        ...
                                        <div class="row g-4">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="robots_txt">{{ __('Robots.txt') }}</label>
                                                    <div class="form-control-wrap">
                                                <textarea type="text" class="form-control"
                                                          id="robots_txt" name="setting_robots_txt">{{ config('options.robots_txt') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
